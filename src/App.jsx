...
function getWeekStart(offset){const d=new Date();d.setDate(d.getDate()-d.getDay()-offset*7);d.setHours(0,0,0,0);return d;}
function getWeek(data,offset){return Array.from({length:7},(_,i)=>{const d=getWeekStart(offset);d.setDate(d.getDate()+i);const k=fmt(d);return{key:k,date:new Date(d),entry:data[k]||{}};});}
        ...
        <div>
          <div style={{...card(isCurrentWeek?P.tealL:P.amberL,isCurrentWeek?P.teal:P.amber,isCurrentWeek?P.tealD:P.amberD),display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            ...
            <span style={{fontSize:12,fontWeight:700}}>
              {isCurrentWeek?"This week":`${w7[0].date.toLocaleDateString("en-GB",{day:"numeric",month:"short"})} — ${w7[6].date.toLocaleDateString("en-GB",{day:"numeric",month:"short"})}`}
            </span>
